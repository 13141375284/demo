...
<template>
  <div id="mine">
    <van-nav-bar title="我的" :fixed="true" :border="false" style="height:2.5rem" />
    ...
    <!-- 订单相关-->
    <van-cell-group>
      <van-cell title="我的订单" icon="label" value="查看全部订单" is-link @click="goTomyOrder(-1)"></van-cell>
...
export default {
  data() {
    return {
      // 头像
      user_image: {
        login_icon: require("./../../images/mine/miao.png"),
