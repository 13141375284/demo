    ...
    <div class="loginBox" @click="changeImage(3)">
      <div class="auth-form">
        ...
        <van-tabs v-model="active" animated>
          ...
          <van-tab title="注册">
            <van-cell-group>
              <van-field v-model="register_userName" clearable placeholder="请输入用户名或手机号" required />
              <van-field
        ...
        <!-- 第三方登录 -->
        <van-divider :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 5px' }">其他登录方式</van-divider>
